...
public class Registration extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !phone_number.isEmpty() && !address.isEmpty()) {
                    registerUser(name, email, password, phone_number, address);
                    Intent intent = new Intent(Registration.this,
                            MainActivity.class);
                    startActivity(intent);
                    finish();
    ...
    private void registerUser(final String name, final String email,
                              final String password, final String phone_number, final String address) {
        // Tag used to cancel the request
        String tag_string_req = "req_register";
        System.out.print(tag_string_req);
                ...
                try {
                    ...
                    if (!error) {
                       ...
                       // String password = user.getString("password");
                        ...
                        db.addUser(name, email,uid , phone_number, address, created_at);
